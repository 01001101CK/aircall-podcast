        ...
        <div className={styles.releasesGrid}>
          <article className={styles.releaseCard}>
            <div className={styles.cardImageWrapper}>
              <Image src="/podcast1.png" alt="The Power of Conversation" fill className='size-full object-cover' loading="eager" />
            </div>
          ...
          <article className={styles.releaseCard}>
            <div className={styles.cardImageWrapper}>
              <Image src="/podcast2.png" alt="The Power of Conversation" fill className='size-full object-cover' loading="eager" />
            </div>
            <div className={styles.cardMeta}>
              <span className={styles.cardMetaEpisode}>S01E01</span>
              <span className={styles.cardMetaDuration}>32MIN</span>
