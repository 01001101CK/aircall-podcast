      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.subscribeSection}>
            ...
            <div className={styles.podcastLinksMobile}>
              <a href="#" className={styles.podcastLink} aria-label="Spotify">
                <Image src="/spotify_mobile.svg" alt="Spotify" width={32} height={32} />
              </a>
              <a href="#" className={styles.podcastLink} aria-label="Deezer">
                <Image src="/deezer_mobile.svg" alt="Deezer" width={32} height={32} />
              </a>
              <a href="#" className={styles.podcastLink} aria-label="Apple Podcast">
                <Image src="/apple_mobile.svg" alt="Apple" width={32} height={32} />
              </a>
            </div>
          </div>
        </div>
